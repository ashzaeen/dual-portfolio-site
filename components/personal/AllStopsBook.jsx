...
// Scroll lock lives here, not in the outer shell, so it releases only after
// AnimatePresence finishes the exit animation and unmounts this component.
// If it lived in AllStopsBook keyed on `open`, it would release the moment
// open→false fires — mid-animation — causing the background layout shift.
function BookSheet({ onClose, ignoreEsc, locations, locationStories, onViewStory }) {
  useScrollLock();
